...
means_by_boldness_group<-aggregate(unpalatable_50/(unpalatable_50+palatable_50)~boldness_cat*group2*exp,data = df_unp50,FUN = mean)
...
# figure 1
gridExtra::grid.arrange(unp50_exp_f,unp50_exp_m,unp50_RY_shy,unp50_RY_bold,unp50_YR_shy,unp50_YR_bold,ncol=2)
